...
module initial_state #(
  ...
  //assume little endian as specified in NIST 800-232
  ...
  assign state_ascon_din[1] = key[127:64];
  assign state_ascon_din[2] = key[63:0];
  assign state_ascon_din[3] = nonce[127:64];
  assign state_ascon_din[4] = nonce[63:0];
